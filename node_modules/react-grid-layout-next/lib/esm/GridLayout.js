...
import { calcGridColWidth, calcXY, resolveRowHeight } from "./calculateUtils";
...
const GridLayout = (properties) => {
    ...
    const onDragOverFn = e => {
        ...
        if (!droppingDOMNode) {
            const calculatedPosition = calcXY(getPositionParams(), layerY, layerX, finalDroppingItem.w, finalDroppingItem.h);
